...
const StyledChip = styled(MuiChip)(({ theme, color, customColor, size, rounded, doted }: { theme: any; color?: any; customColor?: string; size?: string; rounded: boolean; doted: boolean }) => {
  let selectedColor: string = customColor ?? theme?.palette[color]?.main ?? theme.palette["primary"].main;
